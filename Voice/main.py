...
def train(args, io):
    ...
    val_loader = DataLoader(val_dataset, batch_size=16, shuffle=False, collate_fn=collate_fn_pad)
    ...
    for epoch in range(epochs):
        ...
        io.cprint(f"Validation Accuracy: {acc:.4f} - Val Loss: {val_loss_total:.4f}")
